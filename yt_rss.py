            ...
            if "contents" in content:
                for cont in content["contents"]:
                    if "shelfRenderer" not in cont:
                        sys.stderr.write(
                            helper_get_from_dict(cont, ["title", "runs", "text"])
                        )
                        return
                    ...
                    try:
                        if "gridRenderer" in shelf_content:
                            ...
                            items = shelf_content["expandedShelfContentsRenderer"][
                                "items"
                            ]
                        ...
                        for _item in items:
                            item = _item.get("gridVideoRenderer") or _item.get(
                                "videoRenderer"
                            )
...
def load_item(item):
    ...
    for row in item["metadata"]["lockupMetadataViewModel"]["metadata"][
